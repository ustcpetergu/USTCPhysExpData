...
purewl, purestg = load_txt('./17000002/BrWPure.txt')
redwl, redstg = load_txt('./17000002/BrWRed.txt')
bluewl, bluestg = load_txt('./17000002/BrWBlue.txt')
greenwl, greenstg = load_txt('./17000002/BrWGreen.txt')
